...
class Reason:
    ...
    MIXED_CARD_NUMBERS = "mixed_card_numbers"
...
REASON_LABELS: Dict[str, str] = {
    ...
    Reason.MIXED_CARD_NUMBERS: (
        "the comps are more than one card -- an insert and a base card of the same "
        "player, year, set and parallel carry different numbers and different prices"
    ),
...
REASON_CATEGORIES: Dict[str, str] = {
    ...
    Reason.MIXED_CARD_NUMBERS: CATEGORY_DATA_QUALITY,

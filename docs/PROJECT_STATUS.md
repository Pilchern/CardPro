...
- **Scheduling: GitHub Actions** (`.github/workflows/daily-scan.yml`), 14:30
  UTC daily, **plus an 18:30 UTC backup** and manual dispatch. The backup
...
src/
  ...
  run_marker.py             -- when the scan last completed; the 18:30 backup reads it
